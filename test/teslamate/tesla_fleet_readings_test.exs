defmodule TeslaMate.TeslaFleet.ReadingsTest do
  ...
  test "vehicle firmware enables only supported capacity and paired energy fields" do
    for info <- [
          ...
          %{"firmware_version" => "2026.8.300", "fleet_telemetry_version" => "1.2.0"}
        ] do
    ...
    paired =
      Readings.field_config_for_vehicle(10, %{
        "firmware_version" => "2026.26.6",
        "fleet_telemetry_version" => "1.3.0"
      })
    ...
    fields =
      Readings.field_config_for_vehicle(30, %{
        "firmware_version" => "2026.32.1 abc123",
        "fleet_telemetry_version" => "1.3.0"
      })
    ...
    assert Readings.field_config_for_vehicle(30, %{"firmware_version" => "2026.32"})[
